...
class ElcodiProductExtension extends AbstractExtension implements EntitiesOverridableExtensionInterface
{
    ...
    protected function getParametrizationValues(array $config)
    {
        return [
            ...
            "elcodi.core.product.entity.variant.class" => $config['mapping']['variant']['class'],
            "elcodi.core.product.entity.variant.mapping_file" => $config['mapping']['variant']['mapping_file'],
            "elcodi.core.product.entity.variant.manager" => $config['mapping']['variant']['manager'],
            "elcodi.core.product.entity.variant.enabled" => $config['mapping']['variant']['enabled'],
    ...
    public function getEntitiesOverrides()
    {
        return [
            ...
            'Elcodi\Component\Product\Entity\Interfaces\VariantInterface'      => 'elcodi.core.product.entity.variant.class',
